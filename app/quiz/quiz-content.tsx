...
const questions = [
  ...
  },
  {
    id: 5,
    question:
      "Se existisse um método 100% natural, sem remédio, criado por uma mãe como você — pra ajudar seu filho — você toparia conhecer?",
    options: [
  ...
  },
  {
    id: 10,
    question:
      "Se você descobrir que pode estar errando com ele... Você teria coragem de mudar tudo HOJE para melhorar o bem-estar do seu filho?",
    options: [
      { id: "a", text: "Sim, pelo meu filho eu mudo TUDO!" },
      { id: "b", text: "Depende do que for." },
      { id: "c", text: "Não sei..." },
    ],
    tip: "A disposição para mudar é o primeiro passo para transformar o bem-estar do seu filho.",
  },
]
...
export default function QuizContent() {
  ...
  const handleOptionSelect = (optionId: string) => {
    // Rastreia resposta da pergunta
    trackTikTokEvent("AnswerQuestion", {
  ...
  const handleFinish = () => {
    // Rastreia clique no botão "Desbloquear Meu Presente Especial"
    trackTikTokEvent("ClickButton", { button_name: "unlock_gift" })
    playSound("success")
    router.push("/results")
  }
    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-blue-100 py-8 px-4">
      ...
      <div className="max-w-3xl mx-auto relative z-10" ref={confettiRef}>
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-blue-900 mb-2">Quiz para Mães Preocupadas</h1>
