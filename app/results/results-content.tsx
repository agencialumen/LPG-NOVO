...
export default function ResultsContent() {
  ...
  const selectGift = (giftId: string) => {
    ...
    // Rastreia seleção de presente
    trackTikTokEvent("SelectContent", {
      content_type: "gift",
      content_id: giftId,
      content_name: giftOptions.find((g) => g.id === giftId)?.title || "Unknown Gift",
    })
  ...
  const redirectToCheckout = () => {
    ...
    trackTikTokEvent("InitiateCheckout", {
      content_type: "gift",
      content_id: selectedGift,
      content_name: giftOptions.find((g) => g.id === selectedGift)?.title || "Unknown Gift",
      value: 1,
      currency: "BRL",
    })
  ...
  const showGifts = () => {
    // Rastreia visualização das opções de presentes
    trackTikTokEvent("ViewContent", { content_name: "gift_options" })
                      ...
                      >
                        ...
                        <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-6">
                          <p className="text-red-700 font-medium">
                            Com base nas suas respostas, identificamos que seu filho pode estar enfrentando desafios
                            causados por:
                          </p>
                          <ul className="mt-3 space-y-2">
                            <li className="flex items-start gap-2">
                              <span className="text-red-500 font-bold">•</span>
                              <span>Alimentos industrializados que podem afetar o sistema imunológico</span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-red-500 font-bold">•</span>
                              <span>Produtos de limpeza com químicos que podem afetar o sistema respiratório</span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-red-500 font-bold">•</span>
                              <span>Uso frequente de antibióticos que podem afetar a flora intestinal</span>
                            </li>
                          </ul>
                        </div>
